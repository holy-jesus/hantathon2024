() => {
  ...
  const buttonsWithoutAriaLabel = Array.prototype.filter.call(buttons, (btn) => !btn.hasAttribute("aria-label")).map((btn) => Elements.DOMPath.xPath(btn, false))
  return [buttons.length, buttonsWithoutAriaLabel];
};
