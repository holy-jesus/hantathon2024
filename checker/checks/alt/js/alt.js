() => {
  ...
  const imagesWithoutAlt = Array.prototype.filter.call(images, (img) => !img.hasAttribute("alt")).map((img) => Elements.DOMPath.xPath(img, false))
  return [images.length, imagesWithoutAlt];
};
